        ...
        <div class="content-area">
            ...
            <div class="content-area-inner">
                ...
                <section id="intro">
                    ...
                    <div class="container-mid">
                        ...
                        <div class="animation-container animation-fade-left" data-animation-delay="300">
                            ...
                            <p class="subline">Tetap jadikan dirimu berharga dengan segala kekurangan mu bukan untuk menyerah</p>
                        ...
                        <div class="animation-container animation-fade-up" data-animation-delay="600">
                            ...
                            <a href="#about" class="smooth-scroll">Baca Selengkapnya<i class="fa fa-angle-down" aria-hidden="true"></i></a>
                ...
                <section id="about">
                    ...
                    <p class="scroll-animated-from-right">Kebutuhan anda dalam berbisnis bisa kita tampilkan disini dengan beberapa syarat sebagai promosi </p>

                    <p class="scroll-animated-from-right"> Dapatkan keuntungan lebih dalam promosi barang dengan bantuan Web yang kami sarankan untuk insight promosi semakin besar.</p>
                ...
                <section id="contact">
                    ...
                    <ul class="contact-list">
                        ...
                        <li class="scroll-animated-from-right"><i class="fa fa-mobile" aria-hidden="true"></i> +6282287560675</li>
                        <li class="scroll-animated-from-right"><i class="fa fa-envelope-o" aria-hidden="true"></i>Izall09@gmail.com</li>
                ...
                <section id="footer">
                    ...
                    <p class="scroll-animated-from-right">© 2022 Promotion for Future | Design by <a href="https://templatefoundation.com">Template Promotion</a></p>
